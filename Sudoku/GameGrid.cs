	...
	public class GameGrid : ContentPage
	{
		...
		private void CreateControls(Grid grid)
		{
			...
			else
			{
				...
				grid.Children.Add (newGameBtn, 0, 2, 1, 2);
				grid.Children.Add (diffPicker, 0, 2, 2, 3);

				grid.Children.Add (timerLabel, 0, 2, 3, 4);

				grid.Children.Add (hintBtn, 0, 2, 5, 6);
				grid.Children.Add (solveBtn, 0, 2, 6, 7);
				//grid.Children.Add (act, 0, 2, 2, 3);
		...
		private void CreateSelectionButtons(Grid grid)
		{
			...
			for (int i = 0; i < 9; i++) 
			{
				...
				if (IsVertical) 
				{
					grid.Children.Add (btn, i, 14);
				}
				else
				{
					grid.Children.Add (btn, 13, i+1);
				}
		...
		private void CreateClearButtons(Grid grid)
		{
			...
			if (IsVertical) 
			{
				grid.Children.Add (undoBtn, 0, 3, 13, 14);
				grid.Children.Add (ClearSelected, 3, 6, 13, 14);
				grid.Children.Add (ClearAll, 6, 9, 13, 14);
			}
			else 
			{
				grid.Children.Add (undoBtn, 0, 2, 7, 8);
				grid.Children.Add (ClearSelected, 0, 2, 8, 9);
				grid.Children.Add (ClearAll, 0, 2, 9, 10);
			}
		}
